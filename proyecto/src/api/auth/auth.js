...
const { parseBody, generateToken, hashPassword, verifyPassword, withErrorHandling } = require('../../core/auth/auth');
const { success, badRequest, unauthorized, created } = require('../../shared/utils/responses');
