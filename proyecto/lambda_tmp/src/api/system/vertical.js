...
const getVerticalDashboard = withSecureAuth(async (event) => {
...
const getVerticalSpaces = withSecureAuth(async (event) => {
...
const createVerticalReservation = withSecureAuth(async (event) => {
    const user = event.user;
