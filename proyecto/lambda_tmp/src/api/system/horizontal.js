...
const getHorizontalDashboard = withSecureAuth(async (event) => {
...
const getHorizontalSpaces = withSecureAuth(async (event) => {
...
const createHorizontalReservation = withSecureAuth(async (event) => {
    const user = event.user;
    const { 
        espacio_id, 
        fecha, 
